...
import com.mmkarton.mx7.reportgenerator.util.Column;
import com.mmkarton.mx7.reportgenerator.util.ConnectionMetaData;
import com.mmkarton.mx7.reportgenerator.util.ConnectionMetaDataManager;
import com.mmkarton.mx7.reportgenerator.util.Constants;
import com.mmkarton.mx7.reportgenerator.util.Schema;
import com.mmkarton.mx7.reportgenerator.util.Table;
		...
		ISQLSyntax
{
    ...
    public void setDataSourceHandle( DataSourceDesign dataSourceHandle )
	{
		...
		String driverClass =  JdbcMetaDataProvider.getInstance().getDriverClass();
		
		String url = JdbcMetaDataProvider.getInstance().getUrl();
		String user = JdbcMetaDataProvider.getInstance().getUserName();
		String password = JdbcMetaDataProvider.getInstance().getPassword();
